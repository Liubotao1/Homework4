...
import Exception.exception5.myexceptions.MyException;
import Exception.exception5.myexceptions.MyRuntimeException;
...
public class Caller3 {
    ...
    public void callThrowRTException() {
        ...
        try {
            ...
            throw new MyRuntimeException("执行callThrowRTException出错", ex);//调用自己的异常类
        }
